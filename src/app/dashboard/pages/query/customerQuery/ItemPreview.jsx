...
const backUrl = routeURL.cms.customer_query();
const pageTitle = "Customer Query";
...
export default function ItemAdd(props) {
  ...
  const title = data ? `Query from ${data.customer?.name}` : "N/A";
  useEffect(() => {
    if (itemId) {
      setSpinning(true);
      api.query.customer
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Col>
                  <CustomerNotify  subject={`Reply to: "${data?.subject}"`} customer = {data?.customer}>
                    {(loading)=><Form.Item>
                      <Button
                          type="primary"
                          htmlType="submit"
