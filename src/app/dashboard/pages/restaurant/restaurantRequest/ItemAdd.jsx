...
export default function ItemAdd(props) {
	...
	const fillForm = (data) => {
		...
		setPhotoImage({
			...
			citizen: data?.citizenship?.document
				? [data.citizenship.document]
				: [],
			blueBook: data?.blueBook?.document ? [data.blueBook.document] : [],
			insurance: data?.insurance?.document
				? [data.insurance.document]
				: [],
