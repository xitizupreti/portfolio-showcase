...
const backUrl = routeURL.cms.customer_notification();
const pageTitle = "Broadcast Customer Notification";
const imageTitle = "customer_notification";
              ...
              <Row style={rowStyle} gutter={24}>
                <Col xs={24}>
                  <Form.Item
                   ...
                   help="you can style the content when user open notification page inside app"
                 >
                   <Editor
                ...
                <Col>
                  <Form.Item>
                    <Button type="primary" htmlType="submit" loading={false}>
                      {itemId ? "Broadcast Again to all Customers" : "Broadcast to all Customers"}
                    </Button>
                  </Form.Item>
                </Col>
                <Col>
