		...
		if (true) {
			...
			const jsonData = {
				...
				license: {
					...value.license,
					document:
						photoImage.license.length > 0
							? photoImage.license[0]
							: null
				},
				citizenship: {
					...value.citizenship,
					document:
						photoImage.citizen.length > 0
							? photoImage.citizen[0]
							: null
				},
				insurance: {
					...value.insurance,
					document:
						photoImage.insurance.length > 0
							? photoImage.insurance[0]
							: null
				},
				blueBook: {
					...value.blueBook,
					document:
						photoImage.blueBook.length > 0
							? photoImage.blueBook[0]
							: null
				},
				vehicle: {
					...value.vehicle,
					image:
						photoImage.vehicle.length > 0
							? photoImage.vehicle[0]
							: null
				},
		...
		return (
			<>
				<Divider orientation="left">
					...
					>
						Partner's Personal Detail
					</span>
				</Divider>
				<Row style={{ ...rowStyle, marginTop: 20 }}>
					<Form.Item label="Partner Photo *">
						<GalleryUpload
							maxFile={1}
					...
					<Col xs={24} md={12}>
						<Form.Item
							...
							help={
								...
								>
									This will change the commission rate for
									this rider.
								</b>
							}
						>
							...
							rules={[
								{
									required: true,
									message:
										'Please input the Citizenship number!'
								}
							]}
						>
