...
import GalleryUpload from "../../../dashboard/components/GalleryUpload";
...
const backUrl = routeURL.web.rider_request();
...
export default function ItemAdd(props) {
  ...
  return (
    <Row style={{ ...rowStyle, padding: "24px 40px", marginTop: "100px" }}>
      <AddPageLayout
        spinning={spinning}
        title={`Add Rider`}
        breadCrumb={[
